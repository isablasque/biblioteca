...
namespace biblioteca.Controllers
{
    public class LivroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TituloLivro,IdGenero,IdAutor,QuantidadeLivro")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TituloLivro,IdGenero,IdAutor,QuantidadeLivro")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
